...
if __name__ == '__main__':
    ...
    numChains = 4                   #Parallel processes in nuts sampler. Only speeds up computation, doesn't affect results.
    ...
    with hierarchical_model:
        if __name__ == '__main__':
                step = pm.NUTS()
                hierarchical_trace = pm.sample(numMCMCSamples, tune=numMCMCBurnIn, target_accept=targetAcceptProbability,chains = numChains)
